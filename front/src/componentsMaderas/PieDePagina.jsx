...
import { BsCreditCard, BsWhatsapp, BsCashStack } from "react-icons/bs";
...
function PieDePagina() {
  ...
  return (
    <Fondo className="max-w-full h-32  text-white">
      <div className="flex flex-row justify-evenly">
        ...
        <div id="whatsapp" className="flex flex-col">
          <div className="flex flex-row mb-3 mt-3">
            <BsWhatsapp className=" mr-3 mt-1 w-4 h-4"/>
            <h1>WhatsApp</h1>
          </div>
          <div className="h-12 w-12 ml-4">
            <a href="https://api.whatsapp.com/send/?phone=34626105849" target="_blank">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
