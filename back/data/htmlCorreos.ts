function correoRegistroAdmin(emailCorreoRegistro: any, contraseñaCorreoRegistro: any){
  ...
  * {
  ...
  @media only screen and (min-width: 481px) {.t3{mso-line-height-alt:45px!important;line-height:45px!important;display:block!important}.t9{padding-left:50px!important;padding-bottom:60px!important;padding-right:50px!important}.t11{padding-left:50px!important;padding-bottom:60px!important;padding-right:50px!important;width:500px!important}.t15,.t20{padding-bottom:25px!important}.t21{line-height:41px!important;font-size:39px!important;letter-spacing:-1.56px!important}.t35{padding-bottom:60px!important;width:130px!important}.t40{padding-bottom:60px!important}.t45,.t50,.t55,.t60{padding-bottom:45px!important}}
  </style>
  <!--[if !mso]><!-->
  ...
  <body class=t0 style="min-width:100%;Margin:0px;padding:0px;background-color:#24BF27;"><div class=t1 style="background-color:#24BF27;"><table role=presentation width=100% cellpadding=0 cellspacing=0 border=0 align=center><tr><td class=t62 style="font-size:0;line-height:0;mso-line-height-rule:exactly;" valign=top align=center>
  <!--[if mso]>
  ...
  <!--[if !mso]><!--><td class=t15 style="width:600px;padding:0 0 20px 0;">
  <!--<![endif]-->
  <!--[if mso]><td class=t15 style="width:600px;padding:0 0 20px 0;"><![endif]-->
  <h1 class=t21 style="font-family:BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif, 'Albert Sans';line-height:28px;font-weight:800;font-style:normal;font-size:26px;text-decoration:none;text-transform:none;letter-spacing:-1.04px;direction:ltr;color:#191919;text-align:left;mso-line-height-rule:exactly;mso-text-raise:1px;">¡Bienvenido a Maderas Cobo!</h1></td>
  </tr></table>
  </td></tr><tr><td>
  <table class=t24 role=presentation cellpadding=0 cellspacing=0 align=center><tr>
  <!--[if !mso]><!--><td class=t25 style="width:600px;padding:0 0 22px 0;">
  <!--<![endif]-->
  <!--[if mso]><td class=t25 style="width:600px;padding:0 0 22px 0;"><![endif]-->
  </tr></table>
  </td></tr><tr><td>
...
export default correoRegistroAdmin;